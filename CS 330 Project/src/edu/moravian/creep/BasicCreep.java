...
public class BasicCreep implements Creep, Drawable
  {
    ...
    public BasicCreep(Point2D objective, Point2D position, int imageID)
      {
        ...
        heading = Vector2D.zero;
          
        speed = 1;

        currObjective = new Point2D(position);
          
//        path = PathFinder.generatePath(navGraph, position, objective);
      }
...
//        if (path.hasNextWayPoint())
//          { // if our path DOES have a new objective for us...
