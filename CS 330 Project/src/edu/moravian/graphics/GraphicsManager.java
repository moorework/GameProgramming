...
public class GraphicsManager
  {
    ...
    /**
     * Remove a Drawable object from the Manager (if it is present). If the
     * object is not present in the manager nothing is done.
     *
    ...
    /**
     * Add a new Drawable object to the Manager which will be the lowest drawing
     * layer; all other Drawable objects will be drawn on top of this one. This
     * contract is broken if this method is again called later with a new
     * Drawable object.
     *
    ...
    /**
     * Add a new filter to be applied to all of the visual elements being
     * managed by the Graphics Manager.
     *
    ...
    /**
     * Remove a SpriteFilter from the GraphicsManager. If the SpriteFilter is
     * not present in the GraphicsManager, nothing is done.
     *
